...
export class CustomerController{
    ...
    async createCustomer(@Body() customer:CustomerDto){
        ...
        try {
            ...
            throw new HttpException('Bad Request at Creating Customer',HttpStatus.BAD_REQUEST)
    ...
    async getCustomerByName(@Param('name') name:string ){
        ...
        try {
            ...
            throw new HttpException('Bad Request at Finding Customer',HttpStatus.BAD_REQUEST)
